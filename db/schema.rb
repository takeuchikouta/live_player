...
ActiveRecord::Schema.define(version: 2024_11_21_095117) do
  ...
  create_table "follows", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["applicant_id"], name: "index_follows_on_applicant_id"
  ...
  add_foreign_key "follows", "applicants"
  add_foreign_key "follows", "applicants", column: "follow_id"
end
